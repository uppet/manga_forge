...
1. Run `host_game.py test`, `host_game.py pause-test`, `host_game.py save-test`,
   ...
   `host_game.py cast-test`, `host_game.py audio-test`, `host_game.py restoration-test`,
   `host_game.py proof-test`, and `host_game.py soak`.
...
6. Replace draft capsule/store art and localize store copy before public launch.
