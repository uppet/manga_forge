...
Status date: 2026-09-03. This is a production inventory, not legal advice or a
...
Realtime was also used to pre-generate five Japanese Nara Ink Art performances.
...
| Japanese Ink Art voice | 5 | `assets/audio/nara-ink-art-japanese.provenance.md`; lines, model/voice, generation direction, transformations, and hashes retained | Owner approved demo use; publisher/OpenAI terms review before commercial distribution |
...
- Preserve the OpenAI generation account and API billing records for the five
  Japanese voice takes, and confirm the applicable OpenAI terms before a paid
  or otherwise commercial public build.
